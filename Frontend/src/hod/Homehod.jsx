...
export default function Homehod() {
  return (
    <>
      <Box sx={{ display: 'flex' }}>
        <Dashboardhod />
        <Box component='main' sx={{ flexGrow: 1, p: 3 }}>
          ...
          >
            ...
            <Typography align='left' padding='20px'>
              ...
              provides an overview of the university&nbsp;s activities,
              achievements, and financial performance over the course of a year.
              These reports are typically prepared and published by universities
              to inform their various stakeholders, including students, faculty,
              staff, donors, government agencies, and the public, about the
              ...
              in the university&nbsp;s activities and performance over the
              course of a year.
            </Typography>
          </Paper>
        </Box>
